...
public class AzureTableConfiguration {
    ...
    private static final Log LOG = LogFactory.getLog(AzureTableConfiguration.class);
     ...
     * @param accountUri The fully qualified account URI, e.g.
     * http://myacc.table.core.windows.net.
    ...
    public static CloudTableClient createTableClient(Configuration job) throws IOException {
        ...
        LOG.info("Table Stroage Account Name: " + accountName);
        StorageCredentials creds = new StorageCredentialsAccountAndKey(accountName, storageKey);
