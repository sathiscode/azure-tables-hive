...
public abstract class BaseAzureTablePartitioner implements AzureTablePartitioner {
     ...
     *
     * @param results The list of results that we know contains at most one
     * entity.
    ...
    /**
     * Query for the first row in the given table and don't retrieve any actual
     * fields beyond the always-given partition and row keys.
     *
